...
the three models presented perform perfectly in terms of fit to the data, as they have an R-squared of 1 and errors (RMSE and MAE) close to zero. But, these results are extremely good and could indicate an overfitting of the model to the training data.
